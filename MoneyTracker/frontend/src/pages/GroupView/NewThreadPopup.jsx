          ...
          {media.map((mediaItem, index) => {
            ...
            return (
                      ...
                      >
                          {mediaItem.file.type.startsWith('image') && (
                              <img src={mediaItem.url} alt={mediaItem.file.name} className="GroupView-new-thread-popup-post-form-media-preview" />
                          )}
                          {mediaItem.file.type.startsWith('video') && (
                              <video src={mediaItem.url} controls className="GroupView-new-thread-popup-post-form-media-preview" />
                          )}
            ...
            <div className="GroupView-new-thread-popup-sidebar">
              ...
              <input
                ...
                style={{ display: 'none' }} 
              />
                <button className="GroupView-new-thread-popup-button-create" onClick={handleSubmit}>
                  Create</button>
                <button 
            ...
            <div className="GroupView-new-thread-popup-container">
              <button className="GroupView-new-thread-popup-action-buttons" onClick={handleUploadGif}><img src={gif_icon} alt="GIF Icon"/></button>
              <button className="GroupView-new-thread-popup-action-buttons" onClick={handleUploadPhoto}><img src={img_icon} alt="IMG Icon"/></button>
              <button className="GroupView-new-thread-popup-action-buttons" onClick={handleUploadVideo}><img src={video_icon} alt="VIDEO Icon"/></button>
            </div>
            ...
            {emojiArray.map((emoji, index) => (
              <div key={index} 
                ...
                <span className="GroupView-new-thread-popup-emoji">{emoji}</span>
              </div>
            ))}
                  </div>
              </div>
